...
namespace Core.Abstractions.Repositories
{
        ...
        where TRepository : class, IBaseRepository<TIdentifier, TEntity, TRepository>
    {
        ...
        /// </summary>
        /// <returns>
        ///     <see cref="IBaseRepository{TIdentifier, TEntity, TRepository}" />
        /// </returns>
        TRepository NoTrack();
        ...
        Task<int> PatchRecordAsync(TIdentifier id, string data,
        ...
        Task<IEnumerable<TEntity>> CreateBulkAsync(IEnumerable<TEntity> records,
            CancellationToken cancellationToken = default);
        ...
        Task<int> DeleteBulkAsync(IEnumerable<TIdentifier> ids,
            CancellationToken cancellationToken = default);
